...
class Product(models.Model):
    ...
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='active')
    avg_rating = models.DecimalField(max_digits=3, decimal_places=2, default=0, blank=True, null=True)
...
class NutritionalGoal(models.Model):
    ...
    buyer = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='nutritional_goals'
    )
...
class CartItem(models.Model):
    ...
    unit_price = models.DecimalField(max_digits=10, decimal_places=2, help_text="Precio al momento de añadir")
...
class Order(models.Model):
    ...
    transaction_id = models.CharField(max_length=255, blank=True, null=True, help_text="ID externo pasarela")
    stock_reserved_until = models.DateTimeField(blank=True, null=True, help_text="Reserva 15 min")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class OrderItem(models.Model):
    ...
    unit_price = models.DecimalField(max_digits=10, decimal_places=2, help_text="Precio al momento de compra")
    subtotal = models.DecimalField(max_digits=12, decimal_places=2)
...
class PaymentTransaction(models.Model):
    ...
    gateway_ref = models.CharField(max_length=255, blank=True, null=True, help_text="ID en pasarela externa")
    amount = models.DecimalField(max_digits=12, decimal_places=2)
    status = models.CharField(max_length=30, choices=STATUS_CHOICES)
    callback_hash = models.CharField(max_length=255, blank=True, null=True, help_text="Firma validada del callback")
...
class Promotion(models.Model):
    ...
    value = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True, help_text="% o monto fijo")
    starts_at = models.DateTimeField()
    ends_at = models.DateTimeField()
    created_at = models.DateTimeField(auto_now_add=True)

    products = models.ManyToManyField(Product, through='PromotionProduct', related_name='promotions')
...
class UserEvent(models.Model):
    ...
    event_type = models.CharField(max_length=50, help_text="view | search | cart_add | purchase | rating")
