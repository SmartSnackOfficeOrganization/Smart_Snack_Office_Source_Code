...
class Payment(models.Model):
    ...
    auth_code = models.CharField(
        max_length=100, blank=True,
        help_text="Código de autorización"
    )
    ...
    redirect_url = models.URLField(
        blank=True,
        help_text="URL de redirección de Rapyd"
    )
    complete_payment_url = models.URLField(
        blank=True,
        help_text="URL de éxito"
    )
    error_payment_url = models.URLField(
        blank=True,
        help_text="URL de error"
    )
